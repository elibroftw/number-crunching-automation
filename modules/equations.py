"""
===============================================================
A python CLI for various utilities for school
    As it was made very long ago, it does not use argparse
    Nor is it worth the time to add argparse support
Author: Elijah Lopez
===============================================================
"""

import math
from modules import molar_mass
import sys
...
def quadratics():
    ...
    while d < 0:
        try:
            ...
            d = b * b - 4 * a * c
            if d < 0:
                print("Those roots are Invalid, please try again")
        except ValueError:
...
def kinematics():
    ...
    if unneeded == "u":
        ...
        if unknown == "u":
            answer = math.sqrt(v**2 - 2 * a * s)
        elif unknown == "v":
            answer = math.sqrt(u**2 + 2 * a * s)
        elif unknown == "a":
            answer = (v**2 - u**2) / 2 / s
        else:
            answer = (v**2 - u**2) / 2 / a
...
def pascals_triangle():
    ...
    for i in range(0, rows - 2):
        ...
        for j in range(len(temp_row) - 1):
            print_row.append(temp_row[j] + temp_row[j + 1])
        print_row.append(1)
